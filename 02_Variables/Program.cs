...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Alınan Ürün: Patates - " + "Birim Fiyatı: " + potato + " - Gramaj: " + potatoGram + " - Toplam Tutar: " + potatoTotalPrice);
            //Console.WriteLine("Alınan Ürün: Domates - " + "Birim Fiyatı: " + tomato + " - Gramaj: " + tomatoGram + " - Toplam Tutar: " + tomatoTotalPrice);
